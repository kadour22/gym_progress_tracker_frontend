    ...
    <div className="min-h-screen bg-[#0b0b0b] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#111] p-8 rounded-2xl shadow-xl">
        ...
        <form className="flex flex-col gap-4">
          <input type="text" placeholder="Full Name" className="bg-[#1a1a1a] text-white px-4 py-3 rounded-lg outline-none focus:ring-2 focus:ring-lime-400" />
          ...
          <button className="bg-lime-400 text-black py-3 rounded-full font-semibold mt-2">Register</button>
        </form>

        <p className="text-gray-400 text-sm text-center mt-6">
          Already have an account? <Link to="/login" className="text-lime-400 cursor-pointer">Login</Link>
        </p>
      </div>
    </div>
  );
